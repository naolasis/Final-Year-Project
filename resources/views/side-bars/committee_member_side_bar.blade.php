@section('side-bar-content')
    <section class="side-bar-content">
        <ul>
           ...
           <li class="side-bar-list">
            <a class="side-bar-link" href="{{ route('committee_member.view_policy') }}">
           ...
           <li class="side-bar-list">
            <a class="side-bar-link" href="{{ route('committee_member.edit_profile') }}">
