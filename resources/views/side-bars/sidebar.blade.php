<aside class="side-bar">
    <section class="side-bar-head">
        ...
        <div class="user-info">
            <div class="user-photo"><img class="user-photo" src="https://images.pexels.com/photos/935969/pexels-photo-935969.jpeg?auto=compress&cs=tinysrgb&w=600" alt="User Photo"></div>
