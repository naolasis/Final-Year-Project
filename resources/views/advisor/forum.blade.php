            ...
            <div class="forum-section">
                <div class="forum-post">
                    <div class="forum-post-profile">
                        <img src="{{asset('storage/'.auth()->user()->image)}}" alt="pic">
                    </div>
    ...
    <div class="form-container forum">
        @foreach ($posts as $post)
            <div class="forum-section">
                <div class="forum-post">
                    <div class="forum-post-profile">
                        <img src="{{ asset('storage/' . $post->user->image) }}" alt="pic">
                    </div>
                    <div class="forum-post-data">
                        <div class="forum-post-info">
        ...
        <form action="{{ route('forum.post', $group) }}" method="POST" class="add-committee-form" style="display: block;">
            @csrf
            <div class="forum-top-bottom username login-input">
                <input type="text" name="content" class="login-input-field" placeholder="Type your message...">
