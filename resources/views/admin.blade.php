...
@section('content')
<div class="test">hello admin</div>
@endsection
    ...
    <section class="side-bar-content">
        <ul>
           ...
           <li class="side-bar-list">
                ...
                <ul class="inner-list">
                    <li class="inner-lists"><a class="side-bar-link" href="#">Add Committee</a></li>
                </ul>   
           </li>    
        </ul>
    </section>
